...
<h2 class="sub-header ">奖学金 <a href="<?php echo U('Admin/Scholarship/add');?>" type="button" class="add btn btn-primary">添加奖学金</a></h2>
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      <?php if(is_array($scholarship)): foreach($scholarship as $key=>$v): ?><tr>
          <td><?php echo ($v["name"]); ?></td>
          <td><?php echo ($v["studyno"]); ?></td>
          <td><?php echo ($v["period"]); ?></td>
          <td><?php echo ($v["money"]); ?></td>
          <td>
            <a class="btn btn-sm btn-danger" href="<?php echo U('Admin/Scholarship/delete',array('id'=>$v['id']));?>">删除</a>
          </td>
