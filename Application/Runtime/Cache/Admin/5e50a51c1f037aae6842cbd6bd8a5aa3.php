...
<h2 class="sub-header ">学生资助 <a href="<?php echo U('Admin/Funding/add');?>" type="button" class="add btn btn-primary">添加资助</a></h2>
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      <?php if(is_array($funding)): foreach($funding as $key=>$v): ?><tr>
          ...
          <td>
            <a class="btn btn-sm btn-danger" href="<?php echo U('Admin/Funding/delete',array('id'=>$v['id']));?>">删除</a>
          </td>
