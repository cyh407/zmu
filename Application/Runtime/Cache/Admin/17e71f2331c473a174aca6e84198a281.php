...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  $(function(){
	...
	<form method="post" action="<?php echo U('Admin/Notice/updateHandle');?>">
	  <div class="form-group">
	    <label for="title">通知公告名称</label>
	    <input type="input" name="title" class="form-control" id="title" placeholder="通知公告名称" value="<?php echo ($notice['title']); ?>">
	  </div>
	  <div class="form-group">
	    <label for="content">通知公告内容</label>
	    <script id="content" name="content" type="text/plain"><?php echo (stripslashes(htmlspecialchars_decode($notice['content']))); ?></script>
	  </div>
