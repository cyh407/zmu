...
<form action="<?php echo U('Admin/StudentInfo/addHandle');?>" method="post" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="studyno" name="studyno" placeholder="1611740135">
    </div>
  </div>
  <!--年级-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="grade" name="grade" placeholder="2016">
    </div>
  </div>
  <!--班级-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="class" name="class" placeholder="医信">
    </div>
  </div>
  <!--性别-->
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="datetime-local" class="form-control" name="birthday" placeholder="2010-6-1">
    </div>
  </div>
  <!--身份证号-->
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="tel" class="form-control" name="homephone" placeholder="请输入家庭电话">
    </div>
  </div>
  <!--个人电话-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="tel" class="form-control" name="phone" placeholder="请输入个人电话">
    </div>
  </div>
  <!--寝室号-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="roomno" placeholder="请输入寝室号">
    </div>
  </div>
  <!--特长爱好-->
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" name="score" placeholder="请输入高考成绩">
    </div>
  </div>
  <!--是否贷款-->
  <div class="form-group">
