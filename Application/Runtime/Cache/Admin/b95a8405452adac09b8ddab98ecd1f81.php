...
<form action="<?php echo U('Admin/Leave/noHandle');?>" method="post" class="form-horizontal">
  <input type="hidden" value="<?php echo ($leave["id"]); ?>" name="id">
  <!--姓名-->
  <div class="form-group">
    <label for="name" class="col-sm-2 control-label">姓名</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="name" id="name" value="<?php echo ($leave["name"]); ?>" readonly>
    </div>
  </div>
  <!--学号-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="studyno" name="studyno" value="<?php echo ($leave["studyno"]); ?>" readonly>
    </div>
  </div>
  <!--年级-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="grade" name="grade" value="<?php echo ($leave["grade"]); ?>" readonly>
    </div>
  </div>
  <!--班级-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="class" name="class" value="<?php echo ($leave["class"]); ?>" readonly>
    </div>
  </div>
  <!--家庭电话-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="tel" class="form-control" name="homephone" value="<?php echo ($leave["homephone"]); ?>" readonly>
    </div>
  </div>
  <!--个人电话-->
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="tel" class="form-control" name="phone" value="<?php echo ($leave["phone"]); ?>" readonly>
    </div>
  </div>
  <!--请假内容-->
  <div class="form-group">
    <label for="content" class="col-sm-2 control-label">请假内容</label>
    <div class="col-sm-10">
      <textarea class="form-control" name="content" readonly><?php echo ($leave["content"]); ?></textarea>
    </div>
  </div>
  <!--拒绝原因-->
  <div class="form-group">
  ...
  <button type="submit" class="col-md-12 btn btn-danger">拒绝</button>
</form>
